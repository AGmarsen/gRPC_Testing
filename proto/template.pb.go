...
func (x *TimeRequest) GetTimeStamp() int64 {
	if x != nil {
		return x.TimeStamp
	}
	return 0
...
type ChristianTime struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ActualTime int64   `protobuf:"varint,1,opt,name=actualTime,proto3" json:"actualTime,omitempty"`
	Variation  float64 `protobuf:"fixed64,2,opt,name=variation,proto3" json:"variation,omitempty"`
}

func (x *ChristianTime) Reset() {
	*x = ChristianTime{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChristianTime) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChristianTime) ProtoMessage() {}

func (x *ChristianTime) ProtoReflect() protoreflect.Message {
	mi := &file_proto_template_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChristianTime.ProtoReflect.Descriptor instead.
func (*ChristianTime) Descriptor() ([]byte, []int) {
	return file_proto_template_proto_rawDescGZIP(), []int{1}
}

func (x *ChristianTime) GetActualTime() int64 {
	if x != nil {
		return x.ActualTime
	}
	return 0
...
func (x *ChristianTime) GetVariation() float64 {
	if x != nil {
		return x.Variation
	}
	return 0
...
var file_proto_template_proto_rawDesc = []byte{
	...
	,
	...
	0x2e, 0x43, 0x68, 0x72, 0x69, 0x73, 0x74, 0x69, 0x61, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x28,
	0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x47, 0x6d,
	0x61, 0x72, 0x73, 0x65, 0x6e, 0x2f, 0x67, 0x52, 0x50, 0x43, 0x5f, 0x54, 0x65, 0x73, 0x74, 0x69,
...
var file_proto_template_proto_goTypes = []interface{}{
	...
	(*ChristianTime)(nil), // 1: proto.ChristianTime
}
var file_proto_template_proto_depIdxs = []int32{
	0, // 0: proto.Template.RequestTime:input_type -> proto.TimeRequest
	1, // 1: proto.Template.RequestTime:output_type -> proto.ChristianTime
